...
public class SfMap extends HashMap<String, Object> {
     ...
     */
    public SfMap reqQgMap(String key) throws RuntimeException {
    	Object o = req(key);
        if (o instanceof SfMap) {
        	return (SfMap)o ;
        }
    ...
    /**
     * Get the QgDate value associated with a key. If the number value is too
     * large for a QgDate, it will be clipped.
     *
     * @param key   A key string.
     * @return      The qgDate value.
     * @throws RuntimeException if the key is not found or if the value is not a QgDate object.
     */
    public Date reqDate(String key) throws RuntimeException {
        Object o = req(key);
        if(o instanceof Date) {
        	return (Date)o;
        }
        else if (o instanceof Date) {
//        	Date d = new Date((java.util.Date)o);
//        	put(key, d);
//        	return d;
        }
        throw new RuntimeException("No key " + key + " in the map " + this + " is Integer.");
...
//            	put(key, d);
     ...
     * @return      The qgMap.
     */
    public SfMap getSfMap(String key) throws RuntimeException {
    	if (this.containsKey(key)) {
    		try {
    ...
    /**
     * Get an optional qgDate value associated with a key,
     * or null if there is no such key or if the value is not a qgDate.
     *
     * @param key   A key string.
     * @return      A qgDate which is the value.
     */
    public Date getDate(String key) {
    	if (this.containsKey(key)) {
    		try {
				return this.reqDate(key);
			} catch (RuntimeException e) {
			}
    	}
        return null;
